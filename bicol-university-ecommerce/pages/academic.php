...
$stmt = $pdo->prepare("SELECT * FROM products WHERE status = 'active' AND category = 'Academic' $orderBy");
$stmt->execute();
...
<body>
<main class="academic-products">
    <div class="background-decor decor-1"></div>
    <div class="background-decor decor-2"></div>
    <div class="container">
        <div class="page-header animated-header">
            <h1 class="page-title">Academic Products</h1>
            <p class="page-subtitle">Quality educational materials for Bicol University students</p>
        </div>
