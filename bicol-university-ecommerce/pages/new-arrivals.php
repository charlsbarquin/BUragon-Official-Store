...
$stmt = $pdo->query("SELECT * FROM products WHERE status = 'active' ORDER BY created_at DESC LIMIT 12");
$products = $stmt->fetchAll();
?>
<main class="new-arrivals-products">
    ...
    <div class="container">
        <div class="page-header animated-header">
            ...
            <p class="page-subtitle">Discover the latest additions to our BU merchandise collection</p>
        </div>
        <?php if ($products): ?>
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <p>We currently don't have any new products listed. Please check back later.</p>
            </div>
        <?php endif; ?>
    </div>
</main>
