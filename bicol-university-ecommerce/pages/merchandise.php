...
$stmt = $pdo->prepare("SELECT * FROM products WHERE status = 'active' AND category = 'Merchandise' ORDER BY $orderBy");
$stmt->execute();
$products = $stmt->fetchAll();
?>
<main class="merchandise-products">
    ...
    <div class="container">
        <div class="page-header animated-header">
            ...
            <p class="page-subtitle">Official Bicol University merchandise and memorabilia</p>
        </div>
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <h3>No Merchandise Products Available</h3>
                <p>We currently don't have any merchandise products listed. Please check back later.</p>
            </div>
        <?php endif; ?>
    </div>
</main>
