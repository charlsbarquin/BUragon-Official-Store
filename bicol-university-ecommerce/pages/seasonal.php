...
$stmt = $pdo->prepare("SELECT * FROM products WHERE status = 'active' AND category = 'Seasonal'");
$stmt->execute();
$products = $stmt->fetchAll();
?>
<main class="seasonal-products">
    ...
    <div class="container">
        <div class="page-header animated-header">
            ...
            <p class="page-subtitle">Special collections for every season and celebration</p>
        </div>
        <?php if ($products): ?>
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <h3>No Seasonal Products Available</h3>
                <p>We currently don't have any seasonal products listed. Please check back later.</p>
            </div>
        <?php endif; ?>
    </div>
</main>
